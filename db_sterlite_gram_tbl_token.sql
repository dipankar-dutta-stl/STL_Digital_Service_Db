...
CREATE TABLE `tbl_token` (
  ...
  `token_type` enum('reset_password') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `token_status` enum('active','expired','inactive') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
